...
namespace Shriek
{
	public static class ObjectExtensions
	{
		...
		public static IEnumerable<(string Name, dynamic Value)> GetEnumKeyValueTuple(this Type enumType)
		{
			...
			return Enum.GetValues(enumType).Cast<dynamic>().Select(x => (Enum.GetName(enumType, (object)x), x));
		}
		...
		public static IDictionary<string, dynamic> GetEnumKeyValue(this Type enumType)
		{
			...
			return Enum.GetValues(enumType).Cast<dynamic>().ToDictionary(x => Enum.GetName(enumType, (object)x), x => x);
		}
