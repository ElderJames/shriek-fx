...
namespace Shriek.Text
{
    public static class WordsHelper
    {
        ...
        public static string GetPinYinFast(this string text)
        {
        ...
        /// <param name="s"></param>
        /// <returns></returns>
        public static List<string> GetAllPinYin(this char s)
        {
        ...
        /// <param name="s"></param>
        /// <returns></returns>
        public static string ToSenseIllegalWords(this string s)
        {
        ...
        /// <param name="content"></param>
        /// <returns></returns>
        public static bool IsAllChinese(this string content)
        {
            if (Regex.IsMatch(content, @"^[\u4e00-\u9fa5]*$")) {
                return true;
            } else {
        ...
        /// <param name="content"></param>
        /// <returns></returns>
        public static bool HasEnglish(this string content)
        {
        ...
        /// <param name="content"></param>
        /// <returns></returns>
        public static bool IsAllEnglish(this string content)
        {
            if (Regex.IsMatch(content, @"^[A-Za-z]*$")) {
                return true;
            } else {
        ...
        /// <param name="text"></param>
        /// <returns></returns>
        public static string ToTraditionalChinese(this string text)
        {
            StringBuilder sb = new StringBuilder(text);
            for (int i = 0; i < text.Length; i++) {
                var c = text[i];
        ...
        /// <param name="text"></param>
        /// <returns></returns>
        public static string ToSimplifiedChinese(this string text)
        {
            StringBuilder sb = new StringBuilder(text);
            for (int i = 0; i < text.Length; i++) {
                var c = text[i];
        ...
        /// <param name="x"></param>
        /// <returns></returns>
        public static string ToChineseRMB(this decimal x)
        {
